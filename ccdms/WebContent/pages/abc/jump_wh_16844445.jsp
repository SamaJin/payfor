...
<%
		...
		try {
			...
			*/
			...
			//uri="http://172.1.1.31:8090/eapclient/pages/agent_channel_info.jsp?caller_mobile="+caller+"&agent_code="+agentId+"";
			uri="http://172.1.1.31:8090/eapclient/pages/agent_channel_info.jsp?agent_id="+agentId+"&origcalled="+caller+"&called=16844445";
			out.print("跳转中，请梢候。。。");
