...
public class recording_check_result implements Serializable {
	private int id;
	private int recording_id;            //录音ID
	...
	@SequenceGenerator(allocationSize = 1, initialValue = 1, name = "seq_recording_check_result", sequenceName = "seq_1006")
	public int getId() {
		return id;
	}
